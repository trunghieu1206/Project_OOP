...
public class ChooseTypeOfVirusFX {
    ...
    void btnVirusLipidEnvelop(ActionEvent event) {
        try{
            final String PATH = "main_packet/GUIVirusFX/view/VirusWithLipidEnvelopFX.fxml";
    ...
    void btnVirusWithoutLipidEnvelop(ActionEvent event) {
        try{
            final String PATH = "main_packet/GUIVirusFX/view/VirusWithoutLipidEnvelopFX.fxml";
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource(PATH));
