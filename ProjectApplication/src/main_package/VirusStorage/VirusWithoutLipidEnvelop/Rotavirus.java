...
public class Rotavirus extends VirusWithoutLipidEnvelop{
    ...
    public String displayInformation(Virus virus) {
        ...
        str.append("Treatment of rotavirus infection focuses on managing symptoms and preventing dehydration, including drinking rehydration solution, maintaining nutrition or even hospitalization\n");
        return str.toString();
    }
}
